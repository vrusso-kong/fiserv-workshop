...
public class QuoteService {
	...
	protected String quote_url = "https://api.iextrading.com/1.0/stock/{symbol}/quote";

	protected String quotes_url = "https://api.iextrading.com/1.0/stock/market/batch?symbols={symbols}&types=quote";
